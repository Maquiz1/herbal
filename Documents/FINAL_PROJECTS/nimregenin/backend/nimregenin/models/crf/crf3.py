...
class CRF3(models.Model):
    ...
    visit = models.OneToOneField('nimregenin.Visit', on_delete=models.CASCADE, related_name='crf3')
    ...
    alt = models.PositiveIntegerField(null=True, blank=True)
