...
from ....forms import CRF4Form
from ....models import CRF4, Visit
...
class CRF4CreateUpdateView(CreateUpdateView,LoginRequiredMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        if visit:
            ...
            context['title'] = f"{'Edit' if self.object else 'Add'} CRF4 - Concomitant Medications ({visit.enrollment.patient.patient.pid})"
        return context
