...
class CRF3ListView(LoginRequiredMixin, ListView):
    model = CRF3
    template_name = 'nimregenin/crf/crf3/crf3_list.html'
    context_object_name = 'crf3_records'
    paginate_by = 25
    ordering = ['-visit_date', '-created_at']

    def get_queryset(self):
        queryset = CRF3.objects.select_related(
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'CRF3 - Laboratory Results'
        context['search_term'] = self.request.GET.get('search', '')
        context['total_records'] = CRF3.objects.count()
        return context